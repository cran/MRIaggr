...
Line 13 :   \item{max_groups}{the maximum number of groups. \emph{postive integer}.} # MRIaggr-calcGroupsW_cpp.Rd
...
Line 12 :   \item{subset}{the subset of observations to use. \emph{positive integer vector}.} # MRIaggr-calcGroupsW_cpp.Rd
...
Line 20 :   \item{verbose}{should a summary of all attributes should be displayed or only those which are non-empty ? \code{1} or \code{0}.} # MRIaggr-summary.MRIaggr.Rd
...
Line 11 :   \item{W}{the neighbourhood matrix. \emph{dgCMatrix}.} # MRIaggr-calcGroupsW_cpp.Rd
